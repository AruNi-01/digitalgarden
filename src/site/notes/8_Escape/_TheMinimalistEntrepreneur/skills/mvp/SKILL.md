---
{"dg-publish":true,"permalink":"/8-escape/the-minimalist-entrepreneur/skills/mvp/skill/","dg-note-properties":{"name":"mvp","description":"Guide building a minimum viable product the minimalist entrepreneur way — manual first, then processized, then productized. Use when someone is ready to build their first product or struggling with scope."}}
---
