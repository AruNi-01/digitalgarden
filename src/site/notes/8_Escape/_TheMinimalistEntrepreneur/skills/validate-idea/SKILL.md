---
{"dg-publish":true,"permalink":"/8-escape/the-minimalist-entrepreneur/skills/validate-idea/skill/","dg-note-properties":{"name":"validate-idea","description":"Validate a business idea using the minimalist entrepreneur framework. Use when someone has a business idea and wants to test if it's worth pursuing before building anything."}}
---
